...
OneWire oneWireTwo(ONE_WIRE_BUS_TWO);    // SECOND
DallasTemperature sensors(&oneWire);  // Pass our oneWire reference to Dallas Temperature sensor
DallasTemperature sensorsTwo(&oneWireTwo);  // Pass our oneWire reference to Dallas Temperature sensor
...
void loop()
{
  ...
  temperatureC1 = sensorsTwo.getTempCByIndex(0);
...
void DisplayBothTemps() {
  ...
  float test1 = sensorsTwo.getTempCByIndex(0);
